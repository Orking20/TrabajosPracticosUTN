 ...
 *
 * \param pArrayListEmployee LinkedList* Puntero a la lista
 * \return int Retora -1 si el ID del primer elemento es menor o 1 si es mayor
 *
 */
static int ordenarPorId(void* elemento1, void* elemento2)
{
 ...
 *
 * \param pArrayListEmployee LinkedList* Puntero a la lista
 * \return int Retora -1 si el nombre del primer elemento es menor o 1 si es mayor
 *
 */
 ...
 *
 * \param pArrayListEmployee LinkedList* Puntero a la lista
 * \return int Retora -1 si las horas trabajadas del primer elemento son menores o 1 si son mayores
 *
 */
static int ordenarPorHorasTrabajadas(void* elemento1, void* elemento2)
{
 ...
 *
 * \param pArrayListEmployee LinkedList* Puntero a la lista
 * \return int Retora -1 si el sueldo del primer elemento es menor o 1 si es mayor
 *
 */
static int ordenarPorSueldo(void* elemento1, void* elemento2)
{
